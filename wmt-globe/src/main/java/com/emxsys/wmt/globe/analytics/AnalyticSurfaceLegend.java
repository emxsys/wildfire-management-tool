...
public class AnalyticSurfaceLegend implements Renderable
{
    ...
    public static AnalyticSurfaceLegend fromColorGradient(int width, int height, double minValue,
        double maxValue,
    ...
    public static AnalyticSurfaceLegend fromColorGradient(double minValue, double maxValue,
        double minHue,
        ...
        double minValue, double maxValue, Format format)
    {
        ...
        ArrayList<AnalyticSurfaceLegend.LabelAttributes> labels = new ArrayList<>();
    ...
    public static AnalyticSurfaceLegend.LabelAttributes createLegendLabelAttributes(
        final double value,
        final String text, final Font font, final Color color, final double xOffset,
    ...
    protected void drawLabel(DrawContext dc, LabelAttributes attr, double x, double y, String halign,
        String valign)
    {
    ...
    protected BufferedImage createColorGradientLegendImage(int width, int height, double minHue,
        double maxHue,
        Color borderColor)
    {
    ...
    protected Iterable<? extends Renderable> createColorGradientLegendLabels(int width, int height,
        double minValue, double maxValue, Iterable<? extends LabelAttributes> labels,
        LabelAttributes titleLabel)
    {
    ...
    protected static class LabelRenderable implements Renderable
    {
        ...
        public LabelRenderable(AnalyticSurfaceLegend legend, LabelAttributes attr, double x,
            double y,
