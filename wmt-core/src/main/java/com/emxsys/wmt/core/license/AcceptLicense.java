 ...
 */
// This class was copied from o.n.upgrader project within the NetBeans source
...
/**
 * Displays LicensePanel to user. User must accept license to continue. If the user does not accept
 * license UserCancelException is thrown.
 *
 * This license check controlled by setting this property:
 * -J-Dnetbeans.accept_license_class=your.class.here.</br>
 *
 * E.g., -J-Dnetbeans.accept_license_class=com.emxsys.license.AcceptLicense
 *
 * The org.netbeans.core.startup.Main.handleLicenseCheck() method handles this property. It's in the
 * core.startup module. 
 *
 * @author Marek Slama
 */
public final class AcceptLicense
{
    ...
    public static void showLicensePanel() throws Exception
    {
        ...
        final JDialog d = LicenseUtil.createModalDialog(bundle.getString("MSG_LicenseDlgTitle"));
        LicenseUtil.initIcons(d);
    ...
    /**
     * Actual setter of the text & mnemonics for the AbstractButton or their subclasses. We must
     * copy necessary code from org.openide.awt.Mnemonics because org.openide.awt module is not
     * available yet when this code is called.
     *
    ...
    /**
     * Searches for an ampersand in a string which indicates a mnemonic. Recognizes the following
     * cases: <ul> <li>"Drag & Drop", "Ampersand ('&')" - don't have mnemonic ampersand. "&" is not
     * found before " " (space), or if enclosed in "'" (single quotation marks). <li>"&File", "Save
     * &As..." - do have mnemonic ampersand. <li>"Rock & Ro&ll", "Underline the '&' &character" -
     * also do have mnemonic ampersand, but the second one. </ul>
     *
