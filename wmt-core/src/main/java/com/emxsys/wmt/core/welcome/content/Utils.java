...
public class Utils {
    ...
    public static Color getColor(String resId) {
        ResourceBundle bundle = NbBundle.getBundle("com.emxsys.wmt.core.welcome.content.Bundle"); // NOI18N
        try {
    ...
    /**
     * Try to extract the URL from the given DataObject using reflection. (The DataObject should be
     * URLDataObject in most cases)
     */
