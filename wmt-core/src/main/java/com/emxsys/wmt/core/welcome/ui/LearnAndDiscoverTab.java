...
import com.emxsys.wmt.core.welcome.content.ContentSection;
...
class LearnAndDiscoverTab extends AbstractTab
{
    ...
    protected JComponent buildContent()
    {
        ...
        panel.add(new ContentSection(BundleSupport.getLabel("SectionDemosAndTutorials"),
            new Tutorials(), false)); //NOI18N
