...
final class LicensePanel extends javax.swing.JPanel
{
    ...
    {
        this.getAccessibleContext().setAccessibleName(bundle.getString("ACSN_LicensePanel"));
        this.getAccessibleContext().setAccessibleDescription(bundle.getString("ACSD_LicensePanel"));

        jEditorPane1.getAccessibleContext().setAccessibleName(bundle.getString("ACSN_EditorPane"));
        jEditorPane1.getAccessibleContext().setAccessibleDescription(bundle.getString("ACSD_EditorPane"));
    }
    ...
    private void initComponents()
    {
        ...
        jTextAreaTop.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        ...
        jTextAreaBottom.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
