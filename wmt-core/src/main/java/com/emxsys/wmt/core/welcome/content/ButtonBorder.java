...
package com.emxsys.wmt.core.welcome.content;
...
public class ButtonBorder implements Border {
    ...
    private ButtonBorder( boolean mouseOver ) {
        if( mouseOver ) {
            imgLeft = ImageUtilities.loadImage("com/emxsys/wmt/core/welcome/content/sel_btn_left.png");
            imgRight = ImageUtilities.loadImage("com/emxsys/wmt/core/welcome/content/sel_btn_right.png");
            imgCenter = ImageUtilities.loadImage("com/emxsys/wmt/core/welcome/content/sel_btn_center.png");
        } else {
            imgLeft = ImageUtilities.loadImage("com/emxsys/wmt/core/welcome/content/btn_left.png");
            imgRight = ImageUtilities.loadImage("com/emxsys/wmt/core/welcome/content/btn_right.png");
            imgCenter = ImageUtilities.loadImage("com/emxsys/wmt/core/welcome/content/btn_center.png");
        }
    }
