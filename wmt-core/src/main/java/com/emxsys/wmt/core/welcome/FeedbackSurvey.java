...
public final class FeedbackSurvey {
    ...
    public static void start() {
        ...
        catch (IllegalAccessException | IllegalArgumentException | InvocationTargetException | SecurityException | NoSuchMethodError ex) {
    ...
    private static boolean showDialog(URL whereTo) {
        ...
        Object[] buttons
                = {
                    yesButton, laterButton, neverButton
                };
