 ...
 */
package com.emxsys.wmt.core.welcome;

import com.emxsys.wmt.core.welcome.content.Constants;
import com.emxsys.wmt.core.welcome.ui.StartPageContent;
...
public class WelcomeComponent extends TopComponent {
    ...
    /**
     * Overriden to explicitely set persistence type of WelcomeComponent to PERSISTENCE_ALWAYS
     */
    @Override
     ...
     * <p>
     * <em>Note:</em> component is considered to be shown, even its container window is overlapped
     * by another window.</p>
     *
     * @since 2.18
     *
