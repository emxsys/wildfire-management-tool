 ...
 * @author S. Aubrecht
 */
class Issues extends RSSFeedReaderPanel
{
    public Issues()
    {
        super("Issues", false); // NOI18N
    ...
    {
        WebLink allIssues = new WebLink("AllIssues", true); // NOI18N
        BundleSupport.setAccessibilityProperties(allIssues, "AllIssues"); //NOI18N

        JPanel panel = new JPanel(new GridBagLayout());
        panel.setOpaque(false);
        panel.add(allIssues, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.SOUTHEAST, GridBagConstraints.HORIZONTAL, new Insets(5, 5, 0, 5), 0, 0));
