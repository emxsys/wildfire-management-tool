 ...
 * @author S. Aubrecht
 */
class Downloads extends RSSFeedReaderPanel
{
    public Downloads()
    {
        super("Downloads", false); // NOI18N
    ...
    {
        WebLink allDownloads = new WebLink("AllDownloads", true); // NOI18N
        BundleSupport.setAccessibilityProperties(allDownloads, "AllDownloads"); //NOI18N

        JPanel panel = new JPanel(new GridBagLayout());
        panel.setOpaque(false);
        panel.add(allDownloads, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.SOUTHEAST, GridBagConstraints.HORIZONTAL, new Insets(5, 5, 0, 5), 0, 0));
