...
public class Logo extends JPanel implements Constants, MouseListener {
    ...
    public static Logo createOracleLogo() {
        return new Logo( PCF_LOGO_IMAGE, BundleSupport.getURL( "OracleLogo" ) ); // NOI18N
    }

    public static Logo createJavaLogo() {
        return new Logo( CPS_LOGO_IMAGE, BundleSupport.getURL( "JavaLogo" ) ); // NOI18N
    }

    public static Logo createNetBeansLogo() {
        return new Logo( EMXSYS_LOGO_IMAGE, BundleSupport.getURL( "NetBeansLogo" ) ); // NOI18N
    }
